...
enum class GeminiModel(
    ...
    FLASH_LITE_LATEST("gemini-flash-lite-latest", "3.5 Flash-Lite ⚡", "أسرع الإجابات والردود الفورية فائقة السرعة"),
    FLASH_LITE_2_5("gemini-2.5-flash-lite", "2.5 Flash-Lite 🚀", "خفيفة ومعالجة سريعة للنصوص والبيانات"),
    FLASH_3_6("gemini-2.0-flash", "3.6 Flash", "مساعدة متكاملة، البرمجة والتحليل اليومي"),
    FLASH_2_5("gemini-2.5-flash", "2.5 Flash", "البرمجة المتقدمة والتحليل العميق")
}
