                    ...
                    "systemInstruction": {
                        "parts": [{
                            "text": (
                                ...
                                "3. التصفح والبحث المباشر في الويب (Live Web Search & Browsing) وجلب المقالات والمستندات واستخلاص المعرفة منها بدقة.\n"
                                "4. إنشاء وكتابة وتعديل الملفات بكافة لغات البرمجة (Python, Kotlin, JavaScript, C++, HTML, CSS, JSON...) وحفظها وتحديثها فورياً.\n"
